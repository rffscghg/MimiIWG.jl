...
# DICE
scch4 = MimiIWG.compute_scc(DICE, USG1, gas=:CH4, year=2020, prtp=0.025)
scn2o = MimiIWG.compute_scc(DICE, USG1, gas=:N2O, year=2020, prtp=0.025)

# FUND
scch4 = MimiIWG.compute_scc(FUND, USG1, gas=:CH4, year=2020, prtp=0.025)
scn2o = MimiIWG.compute_scc(FUND, USG1, gas=:N2O, year=2020, prtp=0.025)

# PAGE
scch4 = MimiIWG.compute_scc(PAGE, USG1, gas=:CH4, year=2020, prtp=0.025)
scn2o = MimiIWG.compute_scc(PAGE, USG1, gas=:N2O, year=2020, prtp=0.025)
...
# DICE
# (will run for all 3 IWG constant discount rates if none are specified) 
