...
@defcomp IWG_FUND_ClimateForcing begin
    ...
    # Marginal radiative forcing from HFCs (used in SC-HFC calculation)
    rfhfc = Parameter(index=[time])
    ...
    function run_timestep(p, v, d, t)
        ...
        if !is_first(t)
            ...
            v.radforc[t] = v.rfco2[t] + v.rfch4[t] + v.rfn2o[t] + v.rfsf6[t] + p.rfso2[t] + p.rfhfc[t]
